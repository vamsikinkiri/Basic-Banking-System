...
<body style="border: 1px solid #4CAF50">
    <form id="form1" runat="server">
        <div>
            <center>
                <h1 class="Head">Transfer Page</h1><br />               
                <hr class="Line" /><br />  
                <div >
                    <asp:Label CssClass="Lab" ID="Label1" runat="server" Text="Sender Details : "></asp:Label>
                    <br />
                    <br />           
                    <asp:GridView ID="GridView1" CssClass="Grid" DataSourceID="SqlDataSource1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id">
                        <Columns>
                ...
                <div>
                    ...
                    <asp:GridView CssClass="Grid" ID="GridView2" DataSourceID="SqlDataSource3" runat="server"></asp:GridView>
                    &nbsp;
                    <hr class="Line"/><br />
