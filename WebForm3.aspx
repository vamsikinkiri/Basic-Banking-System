...
<body>
    <form id="form1" runat="server">
        <div>
            <center>
                <h1 class="Head">Transaction Page</h1><br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <br /><br />
            <asp:Label CssClass="Lab" ID="Label1" runat="server" Text="Enter the Amount to transfer  : "></asp:Label>
            &nbsp;
            <asp:TextBox CssClass="Txt" ValidationGroup="name_1" ID="TextBox1" runat="server"></asp:TextBox>  
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                ControlToValidate="TextBox1" ErrorMessage="Amount cannot be blank" ValidationGroup="name_1" Font-Size="Large" Text="*" ForeColor="Red"></asp:RequiredFieldValidator> 
            <br /><br /> 
            <asp:Button CssClass="Btn" ID="Button1" runat="server" ValidationGroup="name_1" Text="Transfer" OnClick="Button1_Click" />
            <br />
            <br />
            ...
            <asp:ValidationSummary ID="ValidationSummary1" Font-Size="Large" ValidationGroup="name_1" ForeColor="Red" runat="server" />
                <br />
            ...
            <asp:GridView CssClass="Grid" ID="GridView1" Visible="false" DataSourceID="SqlDataSource1" runat="server"></asp:GridView>
                <br />
